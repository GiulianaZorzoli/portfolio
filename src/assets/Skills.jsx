        ...
        <div className='carouselWrapper'>
          <div className='carouselContainer'>
            <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel">
              ...
              <button className="carousel-control-prev carouselBTN" type="button" data-bs-target="#carouselExampleAutoplaying" data-bs-slide="prev">
                <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                <span className="visually-hidden">Previous</span>
              </button>
              <button className="carousel-control-next carouselBTN" type="button" data-bs-target="#carouselExampleAutoplaying" data-bs-slide="next">
